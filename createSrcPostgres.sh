...
echo "    \"kind\": \"AzurePostgreSql\","                                                     >> work/createSource.json
echo "    \"name\": \"$source_name\","                                                        >> work/createSource.json
echo "    \"description\": \"Placeholder for $source_name\","                                 >> work/createSource.json
echo "    \"qaulifiedName\": \"postgresql://${source_name}\","                                >> work/createSource.json
echo "    \"properties\": {"                                                                  >> work/createSource.json
echo "        \"endpoint\": \"postgressql://${source_name}.postgres.database.azure.com\", "   >> work/createSource.json
